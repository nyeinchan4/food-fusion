<x-layout>
    ...
    <div class="container mx-auto max-w-4xl px-4 py-8">
        <div class="mb-8">
            ...
            <h1 class="text-4xl font-bold mb-2">Edit Event</h1>
            <p class="text-base-content/70">Update event details</p>
        </div>
            ...
            <form action="{{ route('admin.events.update', $event) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-control mb-6">
                    ...
                    <textarea name="description" rows="5" 
                              ...
                              placeholder="Describe the event, what attendees will learn, and what to expect..." required>{{ old('description', $event->description) }}</textarea>
                    @error('description')
                    <label class="label">
                        <span class="label-text-alt text-error">{{ $message }}</span>
                    </label>
                    ...
                    <div class="form-control">
                        ...
                        <label class="label cursor-pointer justify-start gap-4">
                            <input type="checkbox" name="is_active" value="1" 
                                   class="toggle toggle-success" {{ old('is_active', $event->is_active) ? 'checked' : '' }}>
                ...
                <div class="form-control mb-8">
                    <label class="label">
                        <span class="label-text font-semibold">{{ $event->image_path ? 'Replace Image' : 'Event Image' }}</span>
                    </label>
